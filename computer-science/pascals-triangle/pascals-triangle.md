<article class="first">
  <div class="title">
    <h1>Circulus Revertendi: Pascal's Triangle</h1>
  </div>
</article>
...
We'll be using Python scripts which can be found in the [Amulet Repo](https://github.com/pabloagn/amulets/tree/master/computer-science/programming-best-practices-writing-better-code).
