...
<p align="center">
  <img src="https://pabloagn.com/wp-content/uploads/2023/04/AMULET_DUMMY.jpg" height="750" class="amulet-image">
</p>
...
In this Amulet, we'll

We'll be using RegEx scripts which can be found in the [Amulet Repo](https://github.com/pabloagn/amulets/tree/master/data-engineering/programming-best-practices-writing-better-code).
...
# Problem Statement
We are presented with a set of email addresses containing
...
<div class="think-box" align="center">
  <div class="content">
    ...
    <h2 class="main-header">Think About Memory</h2>
    <p class="main-description">Thinking in terms of memory can help uncover useful secrets.</p>
